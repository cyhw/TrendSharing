...
public class CainiaoEvaluator {
    ...
    //parameters
    static int nT = 147350;
    static int nW;
    static double speed = 11.11;
    static String algorithmName;
    static long batchPeriod;
    static double edtRatio = 2;
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        batchPeriod = stol(args[5]);
        //edtRatio = stod(args[8]);

        String outFile = "./cainiao/" + algorithmName + "_" + batchPeriod + "_edt" + edtRatio + "_nW" + nW + "_nT" + nT + "_speed" + speed + ".txt";
